  ...
  return (
    <div className="app">
      ...
      <p className="lede">
        ...
        core also powers the <a href="/vue.html">Vue adapter →</a>
      </p>

      {!supported && (
        <div className="banner">
          Built-in AI globals weren't detected in this browser. The demos still render, but AI
          actions show the <b>unavailable</b> fallback. Use desktop Chrome 138+ with built-in AI
          enabled — see <code>docs/enabling-built-in-ai.md</code>.
        </div>
      )}
